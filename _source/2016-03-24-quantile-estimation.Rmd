...
nn <- signif(10^seq(0, 1.5, 1/4), 1)[-1]
...
for(type in 1:9){
  plot(NULL, xlim=c(1,repetitions), ylim=ylim, panel.first=abline(h=qnorm(Q), v=c(1,5,10,50,100,500,1000), col="lightgray"), main=paste("type ", type), log="", axes=F, frame.plot = T)
...
mtext(paste("running mean of repeated quantile estimation\n for random drawings with n =", n), 3, outer=T, line=1, font=2, cex=1.2)
