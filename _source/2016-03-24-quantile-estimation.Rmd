...
```{r deviation-greater-than-tolerance-type-5, dev="svg", fig.height=6, cache=F}
...
plot(nn2, in_tolerance_low, type="o", pch=20, main="probabilities safe to estimate with tolerable bias", ylab="probabilities", xlab="n", ylim=c(0,1), xlim=c(0,53), xaxt="n", col=5, lwd=2, cex.main=1)
