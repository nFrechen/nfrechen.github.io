...
legend("right", legend=as.character(nn2), col = 1:length(nn2), xpd = NA, lty=1, horiz = F, title="n =", inset = -0.25)
...
plot(nn2, in_tolerance_low, type="o", pch=20, main="type 5", ylab="probabilities tolerable to estimate", xlab="n", ylim=c(0,1), xlim=c(0,35), xaxt="n")
text(nn2, in_tolerance_low, labels = round(in_tolerance_low, 2), adj = c(0,-1))
lines(nn2, in_tolerance_up, type="o", pch=20)
text(nn2, in_tolerance_up, labels = round(in_tolerance_up, 2), adj = c(0,1.8))
axis(1, at = nn2)
```
...
plot(nn2, in_tolerance_low, type="o", pch=20, main="type 7", ylab="probabilities tolerable to estimate", xlab="n", ylim=c(0,1), xlim=c(0,35), xaxt="n")
text(nn2, in_tolerance_low, labels = round(in_tolerance_low, 2), adj = c(0,-1))
lines(nn2, in_tolerance_up, type="o", pch=20)
text(nn2, in_tolerance_up, labels = round(in_tolerance_up, 2), adj = c(0,1.8))
axis(1, at = nn2)
